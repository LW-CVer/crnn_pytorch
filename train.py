...
parser.add_argument('--traindata', type=str,default="./lmdbdata/train_new/", help='path to dataset')
parser.add_argument('--valdata', type=str,default="./lmdbdata/train_new/", help='path to dataset')
...
parser.add_argument('--expr_dir', default='expr_2021_1_21', help='Where to store samples and models')
...
train_dataset = dataset.lmdbDataset(root=opt.traindata)
...
test_dataset = dataset.lmdbDataset(
    root=opt.valdata, transform=dataset.resizeNormalize((128, 32)))
